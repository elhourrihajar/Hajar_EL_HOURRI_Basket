package com.episen.ms_basket.setting;
...
public class InfraSettings {
    ...
    public static KeyPair keypairLoader() {
        ...
        try (FileInputStream is = new FileInputStream("C:\\personnel\\Hajar_EPISEN\\ING3\\S5\\Orchestration_Données\\el_hourri_ms_basket\\src\\main\\resources\\Keys\\server.p12")) {
